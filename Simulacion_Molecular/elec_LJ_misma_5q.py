...
'''
Suma de las fuerzas de LJ y la eléctrica:
'''

def fuerza_total(pos, q, N):
    return fuerza_elec(pos, q, N) + fuerza_LJ(pos, N)
...
anim.save('elec_LJ_misma_5q.gif', writer='pillow', fps=50)
