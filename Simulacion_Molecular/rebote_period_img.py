...
npasos = 100000 # Reduced npasos for faster GIF generation
...
for i in range(npasos):
   ...
   pperiod(pos,N,L)
   if i%(npasos/100)==0: # Save 100 frames for animation
...
anim.save('rebote_period_T500.gif', writer='pillow', fps=50)
